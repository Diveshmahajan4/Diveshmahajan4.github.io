...
let scalerArticles = [
  {
    ...
    content:
      "Stack and Heap memory are allocated to a program by the Java Virtual Machine (JVM)",
    thumbnail: "",
  },
  {
    ...
    content:
      "This article explains the functional programming paradigm, characteristics, implementation in Java with examples",
    thumbnail: "",
  },
  {
  ...
  },
  {
    ...
    content:
      "This article explains HashSet Java with examples for creating a HashSet, adding and removing elements, etc",
    thumbnail: "",
  },
  {
    ...
    content:
      "Variable shadowing and hiding happen when two variables in different scopes are given the same name.",
    thumbnail: "",
  },
  {
    ...
    content:
      "Scaler Topics also explains the operations related to comparable and comparator in Java along with their differences",
    thumbnail: "",
  },
  {
    ...
    content:
      "The CSS position property is used to position HTML elements on a browser viewport",
    thumbnail: "",
  },
];
